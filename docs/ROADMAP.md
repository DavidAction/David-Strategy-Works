...
- Company document upload and profile patching
- Grant template analysis
- Submission brief fields
- Local draft generation
- Multi-provider AI routing skeleton
- HWPX/HTML/JSON export
- Pretendard Variable bundled font
- Grant-readiness scorecard
- Submission format manifest
